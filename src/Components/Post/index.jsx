...
const Post = ({ post, postedBy }) => {
    ...
    const handleDeletePost = async (e) => {
        try {
            ...
            const res = await fetch(`/api/Post/DeletePost/${post.id}`, {
                method: "DELETE",
            });
    ...
    return (
        <Link to={`/${user.username}/Post/${post.id}`}>
            <div className="flex py-2 border-b border-[#ADADAD] dark:border-[#464646]">
                <img
                    className="min-w-10 min-h-10 max-w-10 max-h-10 rounded-full object-cover mt-[4px] cursor-pointer"
                ...
                <div className="w-full px-2 pb-2">
                    ...
                    <div className="flex justify-between gap-2">
                        ...
                        <div className="flex justify-between gap-2">
                            <p className="text-md text-[#999999] dark:text-[#646464]">
